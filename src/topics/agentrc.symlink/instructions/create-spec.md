---
description: Spec Creation Rules for Agentrc
globs:
alwaysApply: false
version: 1.1
encoding: UTF-8
...
<context>
  - Part of Agentrc framework
  - Executed when implementing roadmap items
  - Creates spec-specific documentation
</context>

<prerequisites>
  - Product documentation exists in .agentrc/product/
  - Access to:
    - @.agentrc/product/mission.md,
    - @.agentrc/product/roadmap.md,
    - @.agentrc/product/tech-stack.md
...
<actions> 1. CHECK @.agentrc/product/roadmap.md 2. FIND next uncompleted item 3. SUGGEST item to user 4. WAIT for approval
</actions>
</option_a_flow>
...
<step_metadata>
<reads> - @.agentrc/product/mission.md - @.agentrc/product/roadmap.md - @.agentrc/product/tech-stack.md
</reads>
...
<process> 1. CREATE directory if not exists: .agentrc/specs/ 2. CREATE temporary file: .agentrc/specs/.date-check 3. READ file creation timestamp from filesystem 4. EXTRACT date in YYYY-MM-DD format 5. DELETE temporary file 6. STORE date in variable for folder naming
</process>
</primary_method>
...
<step_metadata>
<creates> - directory: .agentrc/specs/YYYY-MM-DD-spec-name/
</creates>
...
<step_metadata>
<creates> - file: .agentrc/specs/YYYY-MM-DD-spec-name/spec.md
</creates>
</step_metadata>
...
<file_template>
  ...
  <header>
    ...
    This is the technical specification for the spec detailed in @.agentrc/specs/YYYY-MM-DD-spec-name/spec.md
...
<file_template>
  ...
  <header>
    ...
    This is the database schema implementation for the spec detailed in @.agentrc/specs/YYYY-MM-DD-spec-name/spec.md
...
<file_template>
  ...
  <header>
    ...
    This is the API specification for the spec detailed in @.agentrc/specs/YYYY-MM-DD-spec-name/spec.md
...
<file_template>
  ...
  <header>
    ...
    This is the tests coverage details for the spec detailed in @.agentrc/specs/YYYY-MM-DD-spec-name/spec.md
...
- Spec Requirements: @.agentrc/specs/YYYY-MM-DD-spec-name/spec.md
- Technical Spec: @.agentrc/specs/YYYY-MM-DD-spec-name/sub-specs/technical-spec.md
...
<file_template>
  ...
  <header>
    ...
    These are the tasks to be completed for the spec detailed in @.agentrc/specs/YYYY-MM-DD-spec-name/spec.md
...
- Tasks: @.agentrc/specs/YYYY-MM-DD-spec-name/tasks.md
- Technical Specification: @.agentrc/specs/YYYY-MM-DD-spec-name/sub-specs/technical-spec.md
- API Specification: @.agentrc/specs/YYYY-MM-DD-spec-name/sub-specs/api-spec.md
- Database Schema: @.agentrc/specs/YYYY-MM-DD-spec-name/sub-specs/database-schema.md
- Tests Specification: @.agentrc/specs/YYYY-MM-DD-spec-name/sub-specs/tests.md
  </reference_template>
...
<decision_analysis>
<review_against> - @.agentrc/product/mission.md - @.agentrc/product/decisions.md
</review_against>
...
**Related Spec:** @.agentrc/specs/YYYY-MM-DD-spec-name/
...
<instructions>
  ACTION: Analyse spec for strategic decisions
...
Would you like me to proceed with implementing Task 1? I will follow the execution guidelines in @~/.agentrc/instructions/execute-tasks.md and focus only on this first task and its subtasks unless you specify otherwise.
...
REFERENCE: @~/.agentrc/instructions/execute-tasks.md
...
<standards>
  <follow>
    - @.agentrc/product/code-style.md
    - @.agentrc/product/dev-best-practices.md
    - @.agentrc/product/tech-stack.md
  </follow>
  <maintain>
