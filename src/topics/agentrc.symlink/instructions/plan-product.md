---
description: Product Planning Rules for Agentrc
globs:
alwaysApply: false
version: 4.0
encoding: UTF-8
...
<fallback_sequence> 1. @~/.agentrc/standards/tech-stack.md 2. @~/.claude/CLAUDE.md 3. Cursor User Rules
</fallback_sequence>
</data_sources>
...
<step_metadata>
<creates> - directory: .agentrc/product/ - files: 4
</creates>
</step_metadata>
...
<git_config>
<commit_message>Initialize Agentrc product documentation</commit_message>
...
<step_metadata>
<creates> - file: .agentrc/product/mission.md
</creates>
</step_metadata>
...
<step_metadata>
<creates> - file: .agentrc/product/tech-stack.md
</creates>
</step_metadata>
...
<then_check> 1. @~/.agentrc/standards/tech-stack.md 2. @~/.claude/CLAUDE.md 3. Cursor User Rules
</then_check>
...
<step_metadata>
<creates> - file: .agentrc/product/roadmap.md
</creates>
</step_metadata>
...
<step_metadata>
<creates> - file: .agentrc/product/decisions.md
</creates>
...
## Agentrc Documentation

### Product Context

- **Mission & Vision:** @.agentrc/product/mission.md
- **Technical Architecture:** @.agentrc/product/tech-stack.md
- **Development Roadmap:** @.agentrc/product/roadmap.md
- **Decision History:** @.agentrc/product/decisions.md

### Development Standards

- **Code Style:** @~/.agentrc/standards/code-style.md
- **Best Practices:** @~/.agentrc/standards/best-practices.md

### Project Management

- **Active Specs:** @.agentrc/specs/
- **Spec Planning:** Use `@~/.agentrc/instructions/create-spec.md`
- **Tasks Execution:** Use `@~/.agentrc/instructions/execute-tasks.md`

## Workflow Instructions

When asked to work on this codebase:

1. **First**, check @.agentrc/product/roadmap.md for current priorities
2. **Then**, follow the appropriate instruction file:
   - For new features: @.agentrc/instructions/create-spec.md
   - For tasks execution: @.agentrc/instructions/execute-tasks.md
3. **Always**, adhere to the standards in the files listed above

## Important Notes

- Product-specific files in `.agentrc/product/` override any global standards
- User's specific instructions override (or amend) instructions found in `.agentrc/specs/...`
- Always adhere to established patterns, code style, and best practices documented above.
  </content_template>

<merge_behavior>
<if_file_exists>
<check_for_section>"## Agentrc Documentation"</check_for_section>
<if_section_exists>
<action>replace_section</action>
<start_marker>"## Agentrc Documentation"</start_marker>
...
<instructions>
  ...
  MERGE: Replace "Agentrc Documentation" section if it exists
...
<final_checklist>
<verify> - [ ] All 4 files created in .agentrc/product/ - [ ] User inputs incorporated throughout - [ ] Missing tech stack items requested - [ ] Initial decisions documented - [ ] CLAUDE.md created or updated with Agentrc documentation
</verify>
</final_checklist>
