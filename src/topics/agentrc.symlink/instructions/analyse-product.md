---
description: Analyse Current Product & Install Agentrc
globs:
alwaysApply: false
version: 1.0
encoding: UTF-8
...
# Analyse Current Product & Install Agentrc

<ai_meta>
<parsing_rules> - Process XML blocks first for structured data - Execute instructions in sequential order - Use templates as exact patterns - Analyse existing code before generating documentation
</parsing_rules>
...
<purpose>
  - Install Agentrc into an existing codebase
  - Analyse current product state and progress
...
<context>
  ...
  - Used when retrofitting Agentrc to established products
...
<prerequisites>
  ...
  - Access to @~/.agentrc/instructions/plan-product.md
</prerequisites>

<process_flow>

<step number="1" name="analyse_existing_codebase">
...
<instructions>
  ACTION: Thoroughly analyse the existing codebase
...
To properly set up Agentrc, I need to understand:
...
<step_metadata>
<uses>@~/.agentrc/instructions/plan-product.md</uses>
...
<execution_prompt>
@~/.agentrc/instructions/plan-product.md

I'm installing Agentrc into an existing product. Here's what I've gathered:
...
<instructions>
  ...
  ALLOW: plan-product.md to create .agentrc/product/ structure
</instructions>
...
- [ ] .agentrc/product/ directory created
...
## ✅ Agentrc Successfully Installed

I've analysed your [PRODUCT_TYPE] codebase and set up Agentrc with documentation that reflects your actual implementation.
...
- ✓ Product documentation in `.agentrc/product/`
- ✓ Roadmap with completed work in Phase 0
- ✓ Tech stack reflecting actual dependencies

### Next Steps

1. Review the generated documentation in `.agentrc/product/`
2. Make any necessary adjustments to reflect your vision
3. See the Agentrc README for usage instructions: https://github.com/buildermethods/agentrc
4. Start using Agentrc for your next feature:
   ```
   @~/.agentrc/instructions/create-spec.md
   ```

Your codebase is now Agentrc-enabled! 🚀
</summary_template>
...
<final_checklist>
<verify> - [ ] Codebase analysed thoroughly - [ ] User context gathered - [ ] plan-product.md executed with proper context - [ ] Documentation customized for existing product - [ ] Team can adopt Agentrc workflow
</verify>
</final_checklist>
